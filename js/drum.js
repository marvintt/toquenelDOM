...
document.addEventListener("keydown",(e)=>{
    ...
    if (index > -1) {playDrum(drum[index])}
    switch (index){
        case 7: animationCymbal1(); break;
        case 5: animationCymbal2(); break;
        case 0: animationCymbal3(); break;
    }
    switch(index){
        case 1:
        case 2:
        case 3:
        case 4:
        case 6: tom[index].classList.add("active");break;
    }
})
...
function playDrum(dc){
    ...
    drumSound.play();
    if (dc == drum[7]){animationCymbal1()}
    if (dc == drum[5]){animationCymbal2()}
    if (dc == drum[0]){animationCymbal3()}
}
